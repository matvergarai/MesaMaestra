...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">mesa-maestra documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/CardCategoria.html" data-type="entity-link" >CardCategoria</a>
                            </li>
                            <li class="link">
                                <a href="components/CardJuego.html" data-type="entity-link" >CardJuego</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/JuegoNube.html" data-type="entity-link" >JuegoNube</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/PagoExitoso.html" data-type="entity-link" >PagoExitoso</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/Carrito.html" data-type="entity-link" >Carrito</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/HbsRenderService.html" data-type="entity-link" >HbsRenderService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/JuegoNubeService.html" data-type="entity-link" >JuegoNubeService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/ConfigOferta.html" data-type="entity-link" >ConfigOferta</a>
                            </li>
                            <li class="link">
